						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
                                    <form id="medicine_form" method="POST"  action="{{ route('Medicines.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="card card-flush py-4 mt-5">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <select class="form-select" name="category_id" data-control="select2" data-placeholder="Choose category">
                                                        <option></option>
                                        ...
                                        <button type="submit" class="btn btn-primary mt-5">Save Medicine</button>
