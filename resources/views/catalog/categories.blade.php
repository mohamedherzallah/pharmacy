                    ...
                    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                        ...
                        <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                            ...
                            <span class="menu-arrow"></span>
                                    ...
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="users/create.html">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <span class="menu-arrow"></span>
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                <div class="menu-item">
                                                    <a class="menu-link" href="pharmacies/list.html">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="pharmacies/pending.html">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="pharmacies/create.html">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                        ...
                                        <!--begin:Menu item - Products Management-->
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                            <!--begin:Menu link-->
                                            <span class="menu-link">
                            <span class="menu-icon">
                            ...
                            <span class="menu-arrow"></span>
                                    ...
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="products/create.html">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <span class="menu-arrow"></span>
                                    ...
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="categories/create.html">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <span class="menu-arrow"></span>
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                <div class="menu-item">
                                                    <a class="menu-link" href="orders/list.html">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="orders/pending.html">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link" href="reports/analytics.html">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-chart-line fs-2">
                                    ...
                                    <span class="path2"></span>
                                                ...
                                                <span class="menu-title">التقارير والإحصائيات</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->

                                        <!--begin:Menu item - System Logs-->
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link" href="system/logs.html">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-code fs-2">
                                    ...
                                    <span class="path2"></span>
                                                ...
                                                <span class="menu-title">سجلات النظام</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                        ...
                        <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
                            <a href="#" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="نظام الصيدلية الإلكترونية">
					...
					<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
						...
						<div class="d-flex flex-column flex-column-fluid">
                            ...
                            <span class="symbol-label"
                                  style="background-image:url({{ asset('storage/' . $category->avatar) }});">
                            </span>
                                                                </a>
                                ...
                                menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="{{ route('categories.edit', $category->id) }}" class="menu-link px-3">
                                                                        Edit
                                                                    </a>
                                                                </div>
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <form method="POST" action="{{ route('categories.destroy', $category->id) }}">
                                                                        ...
                                                                        @method('DELETE')
                                                                        <button type="submit"
                                                                                class="menu-link px-3 bg-transparent border-0 p-0"
