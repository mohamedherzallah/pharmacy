                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                ...
                                <div class="m-0">
                                    ...
                                    <!--end::Menu toggle-->
                                    <!--begin::Menu 1-->
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_673c0cc0f18a3">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_673c0cc0f18a3" data-allow-clear="true">
                                                        <option></option>
                        ...
                        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            >
                                ...
                                <div class="card card-flush py-4">
                                    <div class="card-header"><h2>Medicine Image</h2></div>
                                    <div class="card-body text-center pt-0">

                                        <div
                                            class="image-input {{ isset($medicine->image) ? '' : 'image-input-empty' }} image-input-outline image-input-placeholder mb-3"
                                            data-kt-image-input="true">

                                            <!-- Current Image Preview -->
                                            <div
                                                class="image-input-wrapper w-150px h-150px"
                                                style="background-image: url('{{ isset($medicine->image) ? asset('storage/' . $medicine->image) : '' }}')">
                                            </div>
                                        ...
                                        <div class="text-muted fs-7">Only *.png, *.jpg, *.jpeg</div>
                                    </div>
                                </div>

                                <!-- General -->
                                <div class="card card-flush py-4 mt-5">
                                    <div class="card-header"><h2>Medicine Information</h2></div>
                                    <div class="card-body pt-0">

                                        <!-- Name -->
                                        <div class="mb-10 fv-row">
                                            <label class="required form-label">Medicine Name</label>
                                            <input
                                                type="text"
                                                name="name"
                                                class="form-control"
