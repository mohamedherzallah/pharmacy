            ...
            <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                ...
                <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                        ...
                                        <!--begin::Add product-->
                                        <a href="{{ route("pharmacy.medicines.add",['pharmacy' => $pharmacy->id]) }}" class="btn btn-primary">Add or update Product</a>
                                        <!--end::Add product-->
                                    </div>
                                    <!--end::Card toolbar-->
                                </div>
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                                        ...
                                        @foreach($medicines as $medicine)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('pharmacy.medicines.destroy', [$pharmacy->id,$medicine->id]) }}" method="POST" onsubmit="return confirm('هل أنت متأكد من الحذف؟');">
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        <a class="btn btn-primary {{ request()->routeIs('pharmacies.index') ? 'active' : '' }}" href="{{ route('pharmacies.index') }}">
